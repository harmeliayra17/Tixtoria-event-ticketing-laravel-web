...
<head>
    ...
    <title>Register as Organizer - Tixtoria</title>
...
<body class="bg-white min-h-screen flex items-center justify-center overflow-x-hidden">
    <div class="flex flex-wrap w-full h-screen shadow-lg">
        ...
        <div class="w-full lg:w-1/2 bg-white flex flex-col justify-center items-center px-4 lg:px-0 py-8 lg:py-0">
            <img src="{{ asset('images/logo.png') }}" alt="Logo" class="h-8 mb-2">
            <h1 class="text-[24px] lg:text-[29px] font-bold mb-0">Register as Organizer</h1>
            <p class="text-gray-600 mb-4 text-center text-sm lg:text-base" style="font-family: Zen Kaku Gothic Antique; font-size:14px">
                Create your Organizer account and start hosting events!
            </p>
            
            <form method="POST" action="{{ route('register.organizer') }}" class="w-full max-w-sm">
                @csrf

                <!-- Name Field -->
                <div class="mb-2 w-full">
                    <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Organization Name</label>
                ...
                <div>
                    <button type="submit" 
                            class="w-full bg-[#640D5F] text-white py-2 px-4 rounded hover:bg-[#1B1464] font-bold">
                        Register Organizer
                    </button>
                </div>
            </form>
            ...
            <p class="text-gray-400 text-xs mt-2 text-center">Registering as a customer? 
                <a href="{{ route('register') }}" class="text-[#640D5F] hover:underline font-semibold">Register here</a>
            </p>
        </div>
    </div>
</body>

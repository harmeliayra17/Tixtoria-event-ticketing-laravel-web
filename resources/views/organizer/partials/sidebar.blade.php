  ...
  <aside class="sidebar-bg w-[215px] h-full text-white flex flex-col">
    ...
    <nav class="flex-1 px-4 mt-1">
      <ul class="space-y-1">
        <ul>
          <li>
            <a href="{{ route('organizer.dashboard') }}" class="flex items-center px-3 py-2 hover:bg-white hover:text-gray-900 rounded-lg transition" onclick="updateTitle('Dashboard', this)">
                <span class="material-icons text-lg mr-3">dashboard</span>
                Dashboard
            </a>
          </li>
          <li>
            <a href="{{ route('organizer.manageEvents') }}" class="flex items-center px-3 py-2 hover:bg-white hover:text-gray-900 rounded-lg transition" onclick="updateTitle('Manage Events', this)">
                <span class="material-icons text-lg mr-3">event</span>
                Manage Events
            </a>
          </li>
          <li>
            <a href="{{ route('organizer.manageTickets') }}" class="flex items-center px-3 py-2 hover:bg-white hover:text-gray-900 rounded-lg transition" onclick="updateTitle('Manage Tickets', this)">
                <span class="material-icons text-lg mr-3">confirmation_number</span>
                Manage Tickets
            </a>
          </li>
          <li>
            <a href="#" class="flex items-center px-3 py-2 hover:bg-white hover:text-gray-900 rounded-lg transition" onclick="updateTitle('Reports', this)">
                <span class="material-icons text-lg mr-3">analytics</span>
                Reports
            </a>
          </li>
          <li>
            <form action="{{ route('organizer.logout') }}" method="POST" class="flex items-center px-3 py-2 hover:bg-white hover:text-gray-900 rounded-lg transition">
                @csrf
